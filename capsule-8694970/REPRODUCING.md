...
`registry.codeocean.com/published/4b4575e6-27af-42ac-8a92-d20fa37142a3:v1`
...
docker run --platform linux/amd64 --rm \
  ...
  registry.codeocean.com/published/4b4575e6-27af-42ac-8a92-d20fa37142a3:v1 bash run
```
